...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-group">
        ...
        <asp:RegularExpressionValidator ErrorMessage="Should be less than 20" ValidationExpression="^.{1,20}$" ControlToValidate="stateTextBox" runat="server" ForeColor="Red" >*</asp:RegularExpressionValidator>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <asp:RegularExpressionValidator ErrorMessage="Should be less than 6" ValidationExpression="^.{1,6}$" ControlToValidate="postalCodeTextBox" runat="server" ForeColor="Red" >*</asp:RegularExpressionValidator>
    </div>
    <asp:Button Text="Add" CssClass="btn btn-primary" ID="Edit" OnClick="Edit_Click" runat="server" />
